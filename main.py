...
class MyServer(BaseHTTPRequestHandler):
    ...
    """
    def get_html(self):
        """ Метод для возвращения ранее собранной страницы"""
...
#                          Зайти в раздел "заказы" и заказать
#                       </div>
#                     </div>
#                   </div>
#                   <div class="col">
...
#                   <td>70.000 рублей</td>
#                   <td>5</td>
#                   <td>350.000 рублей</td>
#                   <td><div class="alert alert-warning" role="alert">В Обработке</div></td>
#               </tr>
#               <tr class="table-secondary">
#                   <td>301</td>
#                   <td>Iphone 13</td>
...
#         """
    ...
    def do_GET(self):
        ...
        # print(query_components)  # На POST запрос,выводит данные пользователя
        page_content = self.get_html()  # Ранее собранная страница
        self.send_response(200)  # Отправка кода ответа
        self.send_header("Content-type", "text/html") # Отправка типа данных, который будет передаваться
        self.end_headers() # Завершение формирования заголовков ответа
        self.wfile.write(bytes(page_content, "utf-8")) # Тело ответа GET запроса
